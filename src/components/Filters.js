...
const Filters = () => {
  ...
  return <Wrapper>
    <div className="content">
        ...
        <div className="form-control">
          ...
          <div className="form-control">
            ...
            <div>
              {categories.map((c, index) => {
                return <button key={index} className={`${category === c.toLowerCase() ? 'active' : null}`} onClick={updateFilters} name="category" type="button" >{c}</button>
              })}
            </div>
          </div>
          ...
          <div className="form-control">
            ...
            <div className="colors">
              {colors.map((c, index) => {
                if(c === 'all') {
                  return <button name="color" key={index} onClick={updateFilters} data-color='all' className={`${color === 'all' ? 'all-btn active' : 'all-btn'}`}>
                    all
                  </button>
                }
      ...
      <button className="btn-clear" onClick={clearFilters} type="button">{' '} clear filters</button>
    </div>
  </Wrapper>
}
